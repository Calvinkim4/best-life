...
class Food extends React.Component {
  ...
  render() {
    const allFoods = this.state.foods.map(food => {
      return (
        <div key={food.id}>
          <li className="food-name" value={food.id}>
            {food.name}
          </li>
          <li className="food-cal" value={food.id}>
            {food.total_calories}
          </li>
          <button value={food.id} onClick={this.showModal}>
            Update
          </button>
          <button value={food.id} onClick={this.onDeleteClick}>
            Delete
          </button>
        </div>
      );
    ...
    const modal =
      this.state.show && this.state.updatedFood ? (
        <div className="modal">
            ...
            <form onSubmit={this.onUpdateClick}>
              <label htmlFor="food">
                <input
                  type="text"
                  name="updatedFood"
                  placeholder={this.state.updatedFood.name}
                  onChange={this.onFoodFormChange}
                />
              </label>
              <label htmlFor="calories">
                <input
                  type="text"
                  name="updatedCalories"
                  placeholder={this.state.updatedFood.total_calories}
                  onChange={this.onFoodFormChange}
                />
              </label>
    ...
    return (
      <div className="food">
        ...
        <div className="food-data">
          <ul className="food-name-list">{allFoods}</ul>
        </div>
        <div>
